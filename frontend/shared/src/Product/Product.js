...
function FullStar(props) {
    return <Svg 
        ...
        >
            ...
            <Path 
                stroke="#E17D23"
                fill="#FFA41C" d="M20.388,10.918L32,12.118l-8.735,7.749L25.914,31.4l-9.893-6.088L6.127,31.4l2.695-11.533L0,12.118
...
function HalfStar(props) {
    return <Svg 
        ...
        >
            <G id="half-star"> 
                <Polygon fill="#fff" 
                        stroke="#E17D23" points="32,12.118 20.389,10.918 16.026,0.6 16,0.66 16,25.325 16.021,25.312 25.914,31.4 23.266,19.867
                "></Polygon>
                <Polygon fill="#FFA41C" 
                        stroke="#E17D23"
                points="11.547,10.918 0,12.118 8.822,19.867 6.127,31.4 16,25.325 16,0.66 	"></Polygon>
            </G> 
        </Svg>;
}
...
const Stars = (props) => {
    ...
    if (props.ratings) {
        ...
        rating =
        (((Math.round((props.ratings * 10) / 5) * 5) / 10) * 20).toString() + "%";
    }
    ...
    return (
        <View style={styles.back}>
          ...
          <IconStar />
          <IconStar />
          <View style={[{width: rating}, styles.front]}>
            <IconStar />
            <IconStar />
            <IconStar />
            <IconStar />
...
export const Ratings = (props) => {
    ...
    return (
        <View style={styles.ratings}>
            {props.ratings || "N/A"}<Stars ratings={props.ratings}/>
        </View>
    )
}
